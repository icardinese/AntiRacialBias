...
# Convert to DataFrame to drop rows with NaN values
X_compas_recidivism_train_df = pd.DataFrame(X_compas_recidivism_train, index=X_recidivism_train_indices)
X_compas_recidivism_test_df = pd.DataFrame(X_compas_recidivism_test, index=X_recidivism_test_indices)
X_compas_violence_train_df = pd.DataFrame(X_compas_violence_train, index=X_violence_train_indices)
X_compas_violence_test_df = pd.DataFrame(X_compas_violence_test, index=X_violence_test_indices)
...
# Preprocess the data for the original recidivism pipeline
X_compas_recidivism_train, X_compas_recidivism_test = recidivism_preproccessing.preprocessor(X_compas_recidivism_train, X_compas_recidivism_test)
X_compas_violence_train, X_compas_violence_test = violence_preproccessing.preprocessor(X_compas_violence_train, X_compas_violence_test)
