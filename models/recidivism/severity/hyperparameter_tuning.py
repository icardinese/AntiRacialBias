...
xgb_param_grid = {
    ...
    'objective': ['multi:softmax'],  # Updated for multi-class classification
    'num_class': [9]  # Number of classes for severity levels (0-8)
}
...
def hyperparametertuning(model, param_grid, X_train, y_train, label):
    ...
    # Get best parameters and save them to a new JSON file named 'severity_hyperparameters.json'
